...
export const myProjects = [
  ...
  {
    "id": 2,
    "title": "4O Fashion E-commerce Project",
    "description": "A full-featured fashion e-commerce web app supporting product browsing, shopping cart, wishlist, user authentication, and order processing.",
    "subDescription": [
      "Built with MVVM architecture using vanilla JavaScript and RESTful API.",
      "Implemented cart, wishlist, checkout, and user account features.",
      "Connected to backend API for authentication, orders, and payments.",
      "Modularized codebase for maintainability and scalability.",
      "Designed responsive UI for all major screens and devices."
    ],
    "href": "https://github.com/TagKrj/4OShop",
    "logo": "",
    "image": "/assets/projects/home4O.png",
    "tags": [
      {
        "id": 1,
        "name": "JavaScript",
  ...
  {
    "id": 3,
    "title": "WebBooks E-commerce Project",
    "description": "An online bookstore platform with full e-commerce features including cart, wishlist, and payment system.",
    "subDescription": [
      "Built using MVC architecture with vanilla JavaScript and RESTful API.",
      "Features user login, book catalog, cart, wishlist, and checkout flow.",
      "Connected to backend API for authentication, orders, and payments.",
      "Modular controller-based structure for clean and scalable code.",
      "Responsive UI with custom styling and dynamic content rendering."
    ],
    "href": "https://github.com/TagKrj/Bookstore",
    "logo": "",
    "image": "/assets/projects/webBookHome.png",
    "tags": [
      {
        "id": 1,
        "name": "JavaScript",
