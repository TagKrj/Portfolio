        ...
        <section id="about"
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-6 md:auto-rows-[18rem] mt-12">
                ...
                <div
                    ...
                    <div ref={gird2Container} className="flex items-center justify-center w-full h-full">
                        ...
                        <Card
                            ...
                            image="/assets/logos/cdnlogo.com_react.svg"
                            containerRef={gird2Container} />
                        <Card
                            style={{ rotate: "-45deg", top: "70%", left: "25%" }}
                            image="/assets/logos/tailwind.com.png"
                            containerRef={gird2Container} />
                        <Card
                ...
                <div
                    ...
                    <div className="z-10 w-[50%]">
                        ...
                        <p className="subtext">I'm based in Mars, and open to remote work worlwide</p>
